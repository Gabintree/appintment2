    ...
    <div className="flex justify-center items-center h-screen bg-gray-200">
      ...
      <div className="bg-white p-8 shadow-lg w-full max-w-md">
        ...
        <div className="flex justify-center mb-6">
          <button
            className="w-full py-2 bg-teal-200 text-gray-800 font-bold rounded-tl-lg focus:outline-none"
            onClick={(e) => formOnChange("userBtn")}
          >
            {userText}
          </button>
          <button
            className="w-full py-2 bg-gray-200 text-gray-800 font-bold rounded-tr-lg focus:outline-none"
            onClick={(e) => formOnChange("adminBtn")}
          >
            {adminText}
          </button>
        </div>
        ...
        />
        <button
          className="w-full bg-teal-500 text-white py-2 mt-9 hover:bg-teal-600 transition"
          type="submit"
